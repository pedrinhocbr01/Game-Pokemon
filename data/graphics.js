...
// Mega/Dynamax/Tera (e demais animTransform) NÃO devem soltar grito — o cry toca
// só no aparecimento (animSummon) e ao desmaiar (animFaint). Removido o playEffect aqui.
...
if(pokemon.shiny)buf+=" <span class=\"tt-shiny\" title=\"Shiny\">★</span>";   /* shiny: estrela entre nome e level (RPG) */
...
$prevhp.css('width',pokemon.hpWidth(129)+1);
